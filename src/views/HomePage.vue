...
<!-- Begin carousel -->
  ...
  <div class="teal">
    ...
    <div class="container center">
      <router-link to="/subscribtiion" class="m-y-4px btn white black-text bold waves-effect waves-teal">Pricing</router-link> &nbsp;
...
export default {
  ...
  created(){
    // this.carouselInstance = M.Carousel.getInstance(document.querySelector('.carousel'));
